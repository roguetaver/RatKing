...
half4 getPal(float pos){
   return SAMPLE_TEXTURE2D(_TexPalette, sampler_LinearClamp, float2(pos/_ResPalette,.5) ).xyzw; //need uint coz of lerp
   // return SAMPLE_TEXTURE2D_X(_TexPalette, sampler_TexPalette, float2(pos/_ResPalette,.5) ).xyzw; //need uint coz of lerp
}
